...
def run_ML(model_id,n_steps_out):
    ...
    n_station=9 
    string='C:/Users/USER/Desktop/project/ML/data_chg_ML_'
    station=[string+'1.csv']
...
def run(model_id, n_steps_in,n_steps_out,n_features,n_epoch,n_trivals,n_out,
    ...
    n_station=9
    string='C:/Users/USER/Desktop/project/mixed_LSTM/data_chg_'
    string2='C:/Users/USER/Desktop/project/mixed_LSTM/data_chg_pred_occ_t_'
    station=[string+'1.csv']
    station2=[string2+'1.csv']
